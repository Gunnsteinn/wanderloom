        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our software products are designed to streamline operations and
              enhance customer experience for travel agencies and transportation
              services. We offer innovative solutions that ensure efficiency and
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our solutions deliver tangible results, driving efficiency and
              profitability for travel agencies and transportation services. We
              empower our clients to achieve their business objectives and
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our onboarding process is tailored to meet the specific
              requirements of travel agencies and transportation services for
              tourists. We ensure a smooth transition and comprehensive training
              for optimal utilization of our software solutions.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              We prioritize quality in every aspect of our services, ensuring
              superior performance and reliability for travel agencies and
              transportation services. Our commitment to excellence guarantees
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our sales team specializes in catering to the unique needs of
              travel agencies and tourist transportation services. We offer
              tailored solutions to maximize revenue and foster growth.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our support services ensure seamless operations for travel
              agencies and transportation services. We provide round-the-clock
              assistance to address any issues or queries promptly.
            </p>
          </div>
        </div>
      </div>
